    ...
    <div className="space-y-6 max-w-7xl mx-auto w-full">
      ...
      {showForm && (
        <form className="bg-white/90 backdrop-blur-md rounded-2xl p-6 border border-white/80 space-y-5 shadow-xl animate-fadeIn">
          ...
          <div className="flex items-center flex-wrap justify-end gap-3 pt-4 border-t border-slate-100">
            <button
              type="button"
              onClick={resetForm}
              disabled={submitting}
              className="shrink-0 whitespace-nowrap px-6 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-600 font-black rounded-xl border-b-4 border-slate-300 transition-all duration-100 active:translate-y-0.5 active:border-b-0 text-xs disabled:opacity-50"
            >
              Cancel
            </button>
            <button
              ...
              disabled={submitting}
              className="shrink-0 whitespace-nowrap bg-white hover:bg-slate-50 text-slate-700 font-black px-6 py-2.5 rounded-xl border border-slate-200 border-b-4 border-slate-300 flex items-center gap-2 shadow-md transition-all duration-100 hover:-translate-y-0.5 active:translate-y-0.5 active:border-b-0 text-xs disabled:opacity-50"
            >
            ...
            <button
              ...
              disabled={submitting}
              className="shrink-0 whitespace-nowrap bg-[#F8B936] hover:bg-[#DC8C18] text-[#521903] font-black px-6 py-2.5 rounded-xl border-b-4 border-[#DC8C18] flex items-center gap-2 shadow-md transition-all duration-100 hover:-translate-y-0.5 active:translate-y-0.5 active:border-b-0 text-xs disabled:opacity-50"
            >
